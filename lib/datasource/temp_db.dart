...
class TempDB {
  ...
  static List<BusRoute> tableRoute = [
    BusRoute(routeId: 1, routeName: 'Phnom Penh-Sihanoukville', cityFrom: 'Phnom Penh', cityTo: 'Sihanoukville', distanceInKm: 250),
    BusRoute(routeId: 2, routeName: 'Sihanoukville-Phnom Penh', cityFrom: 'Sihanoukville', cityTo: 'Phnom Penh', distanceInKm: 250),
  ];
